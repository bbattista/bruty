...
<qgis styleCategories="LayerConfiguration|Symbology|Labeling|Actions" readOnly="0" version="3.28.3-Firenze" labelsEnabled="1">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer" forceraster="0" enableorderby="1" referencescale="-1">
    <rules key="{1b1645df-c77c-4f39-80b6-ae0e58b962e7}">
      ...
      <rule symbol="7" label="Export Complete" filter="attribute(@feature, 'export_code')&lt;=0 and (attribute(@feature, 'export_request_time') &lt;= attribute(@feature, 'export_start_time') and attribute(@feature, 'export_start_time') &lt;= attribute(@feature, 'export_end_time')) and (attribute(@feature, 'combine_end_time')&lt; attribute(@feature, 'export_end_time'))" key="{62ff6119-ff97-4798-bf22-59c509df3242}"/>
    </rules>
    <symbols>
